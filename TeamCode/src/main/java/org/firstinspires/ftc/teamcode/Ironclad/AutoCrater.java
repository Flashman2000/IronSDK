...
public class AutoCrater extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            robot.leftDrive.setTargetPosition(1100);
            robot.rightDrive.setTargetPosition(1100);
            robot.leftDrive.setPower(1);
            robot.rightDrive.setPower(1);
            ...
            robot.rightDrive.setTargetPosition(-2250);
            robot.leftDrive.setTargetPosition(-2250);
            robot.rightDrive.setPower(-1);
            robot.leftDrive.setPower(-1);
